...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_130: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_584: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_410: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_599: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_408: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_409: (a: number, b: number) => void;
